      ...
      >
        ...
        <el-form-item label="图书封面" prop="coverUrl">
          <div class="upload-container">
            ...
            >
              <img v-if="bookForm.coverUrl" :src="bookForm.coverUrl.startsWith('http') ? bookForm.coverUrl : ('/api' + bookForm.coverUrl)" class="cover-preview" />
